...
<b-container fluid style="padding:0px">
   ...
   <b-navbar  style="    padding-bottom: 12px;
    padding-top: 12px;  background-color: #ffb4c6ab!important; box-shadow: 0px 2px 3px -1px rgba(126, 126, 126, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0), 0px 1px 10px 0px #00000003;"toggleable variant="light">

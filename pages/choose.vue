...
<br>
<img style="width :95%" src="https://www.sorns.co/wp-content/uploads/2018/01/sds.png" alt="">
    </b-container>
</template>
...
button{
    ...
    width: 80%;
    margin-bottom: 9px;
box-shadow: rgba(132, 125, 125, 0.2) -1px 1px 6px 0px, rgba(255, 255, 255, 0.83) 0px 4px 5px 0px, rgba(0, 0, 0, .01) 0px 1px 10px 0px;
}
</style>

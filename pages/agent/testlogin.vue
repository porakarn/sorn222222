...
import axios from 'axios';
  ...
  export default {
   ...
   e1: 'recent',
  url:'https://www.facebook.com/v3.0/dialog/oauth?client_id=1164801473596989&redirect_uri=https://sorns-co-beta.herokuapp.com/agent/testlogin&scope=email'
...
axios.get(`https://graph.facebook.com/v3.0/oauth/access_token?client_id=1164801473596989&redirect_uri=https://sorns-co-beta.herokuapp.com/agent/testlogin&client_secret=24ca12cded8182db8628ddf7772b746e&code=${code}`)
    .then(x=>{

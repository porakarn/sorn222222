...
" >
       ...
       <b-row style="margin-top: 10px;">
         ...
         <b-col cols="12" style="padding-left: 15px; padding-right: 2px;">
<p style="
  font-family: Roboto;
  font-size: 16px;
  font-weight: bold;
  ...
  text-align: left;
  margin-bottom: 0px;
  color: #2c2929;">ภาษาจีน    <strong style=" background-color:#EEC0BB;
    border-radius: 6px;
    color: white;
    font-weight: 500;
    padding-right: 9px;
...
" >
    เรียนภาษาจีน วันพุธ 300 บาท / ชม ที่สยามพารากอน ขอติวเตอร์เก่ง</p>
<p style="color:#545454; font-size:14px   ;  margin-bottom: 2px;">
   </p>
...
">
    <b-col cols="6"style="margin-top: 14px; padding-right: 0px; ">
 ...
 <b-button v-b-modal.modal1  class="responsive" style="font-size: 17px;
    ...
    padding-top:9px;
    padding-bottom:9px;
"> แก้ไขประกาศ</b-button>
</div>
    </b-col>
     <b-col cols="6"style="margin-top: 14px; padding-left: 0px; ">
                 <div style="text-align:center">
